...
TINY.editor=function(){
	...
	c['orderedlist']=[10,'Numbered List','a','ol', null, null, 'list-ol'];
	c['unorderedlist']=[11,'Bulleted List','a','ul', null, null, 'list-ul'];
	c['link']=[22,'Link','i','link','Enter link address:','http://', 'link'];
	function edit(n,obj){
		var defaults = {controlclass: 'tecontrol', width: '100%', controls:['bold','italic','underline', 'orderedlist','unorderedlist','link']}
		...
		for(i;i<l;i++){
			...
			if(c[id]){
				...
				if (x[6]){
					 div.innerHTML='<i class="fa fa-fw fa-'+x[6]+'"></i>'
